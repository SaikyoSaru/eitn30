...
public:
  ...
  friend class ostream &operator<<(ostream &theStream,
                                   const EthernetAddress &theAddress);
...
public:
  ...
  enum {
    txStartAddress = 0x40000000,
    txBufferSize = 0x2000,
    txBufferPages = 32
  };

  enum {
    rxStartAddress = 0x40008000,
...
public:
  EthernetInPacket(byte *theData, udword theLength, InPacket *theFrame);
